...
<main class="relative h-full w-full px-5 lg:container lg:mx-auto lg:w-[1120px]">
	<form method="POST">
		<input
			...
			type="text"
			class="w-full bg-transparent text-[26px] font-bold tracking-tight"
		...
		<div class="grid w-full grid-cols-12 gap-5">
			<div class="col-span-8 mb-40">
				<input
					bind:value={$form.title}
					type="text"
					class="my-2 w-full bg-transparent text-xl font-bold tracking-tight"
					placeholder="Enter a title" />
				<Textarea bind:value={$form.description} placeholder="Type your description here." class="h-[300px] p-0 text-lg" />
